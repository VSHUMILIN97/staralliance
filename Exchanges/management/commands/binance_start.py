...
def poloniex_subprocess():
    try:
        script_path = os.path.join(os.path.dirname(__file__), '../../../Exchanges/ExchangeAPI/binanceAPI.py')
    except FileNotFoundError:
        logging.error(u'BinanceAPI process could not be reached. Check File path')
        sys.exit(-1)
